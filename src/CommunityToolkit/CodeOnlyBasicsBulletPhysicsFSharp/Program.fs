...
let Start (scene: Scene) =
    ...
    let primitive1 = game.Create3DPrimitive(PrimitiveModelType.Cube, new Bullet3DPhysicsOptions(
    ...
    let primitive2 = game.Create3DPrimitive(PrimitiveModelType.Cube, new Bullet3DPhysicsOptions(
...
let Update (scene: Scene) (time: GameTime) =
    ...
    if game.Input.IsKeyDown(Keys.Space) then
        let entity = game.Create3DPrimitive(PrimitiveModelType.Cube, new Bullet3DPhysicsOptions(
